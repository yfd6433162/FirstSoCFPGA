...
module soc_system_mm_interconnect_0 (
		...
		output wire [2:0]  CAM_FRAME_NUM_s1_address,                                         //                                           CAM_FRAME_NUM_s1.address
		input  wire [31:0] CAM_FRAME_NUM_s1_readdata,                                        //                                                           .readdata
		output wire [2:0]  CAM_WR_EN_s1_address,                                             //                                               CAM_WR_EN_s1.address
		output wire        CAM_WR_EN_s1_write,                                               //                                                           .write
		input  wire [31:0] CAM_WR_EN_s1_readdata,                                            //                                                           .readdata
		output wire [31:0] CAM_WR_EN_s1_writedata,                                           //                                                           .writedata
		output wire        CAM_WR_EN_s1_chipselect,                                          //                                                           .chipselect
		...
		output wire [2:0]  LCD_CLK_s1_address,                                               //                                                 LCD_CLK_s1.address
		output wire        LCD_CLK_s1_write,                                                 //                                                           .write
		input  wire [31:0] LCD_CLK_s1_readdata,                                              //                                                           .readdata
		output wire [31:0] LCD_CLK_s1_writedata,                                             //                                                           .writedata
		output wire        LCD_CLK_s1_chipselect,                                            //                                                           .chipselect
		output wire [2:0]  LCD_DATA_s1_address,                                              //                                                LCD_DATA_s1.address
	...
	wire   [31:0] sda_s1_agent_m0_address;                                                            // SDA_s1_agent:m0_address -> SDA_s1_translator:uav_address
	...
	wire  [131:0] sda_s1_agent_rf_source_data;                                                        // SDA_s1_agent:rf_source_data -> SDA_s1_agent_rsp_fifo:in_data
	...
	wire  [131:0] sda_s1_agent_rsp_fifo_out_data;                                                     // SDA_s1_agent_rsp_fifo:out_data -> SDA_s1_agent:rf_sink_data
	...
	wire          sda_s1_agent_rdata_fifo_src_valid;                                                  // SDA_s1_agent:rdata_fifo_src_valid -> SDA_s1_agent_rdata_fifo:in_valid
	wire   [33:0] sda_s1_agent_rdata_fifo_src_data;                                                   // SDA_s1_agent:rdata_fifo_src_data -> SDA_s1_agent_rdata_fifo:in_data
	wire          sda_s1_agent_rdata_fifo_src_ready;                                                  // SDA_s1_agent_rdata_fifo:in_ready -> SDA_s1_agent:rdata_fifo_src_ready
	...
	wire   [31:0] scl_s1_agent_m0_address;                                                            // SCL_s1_agent:m0_address -> SCL_s1_translator:uav_address
	...
	wire  [131:0] scl_s1_agent_rf_source_data;                                                        // SCL_s1_agent:rf_source_data -> SCL_s1_agent_rsp_fifo:in_data
	...
	wire  [131:0] scl_s1_agent_rsp_fifo_out_data;                                                     // SCL_s1_agent_rsp_fifo:out_data -> SCL_s1_agent:rf_sink_data
	...
	wire          scl_s1_agent_rdata_fifo_src_valid;                                                  // SCL_s1_agent:rdata_fifo_src_valid -> SCL_s1_agent_rdata_fifo:in_valid
	wire   [33:0] scl_s1_agent_rdata_fifo_src_data;                                                   // SCL_s1_agent:rdata_fifo_src_data -> SCL_s1_agent_rdata_fifo:in_data
	wire          scl_s1_agent_rdata_fifo_src_ready;                                                  // SCL_s1_agent_rdata_fifo:in_ready -> SCL_s1_agent:rdata_fifo_src_ready
	...
	wire  [131:0] lcd_data_s1_agent_rf_source_data;                                                   // LCD_DATA_s1_agent:rf_source_data -> LCD_DATA_s1_agent_rsp_fifo:in_data
	...
	wire  [131:0] lcd_data_s1_agent_rsp_fifo_out_data;                                                // LCD_DATA_s1_agent_rsp_fifo:out_data -> LCD_DATA_s1_agent:rf_sink_data
	...
	wire          lcd_data_s1_agent_rdata_fifo_src_valid;                                             // LCD_DATA_s1_agent:rdata_fifo_src_valid -> LCD_DATA_s1_agent_rdata_fifo:in_valid
	wire   [33:0] lcd_data_s1_agent_rdata_fifo_src_data;                                              // LCD_DATA_s1_agent:rdata_fifo_src_data -> LCD_DATA_s1_agent_rdata_fifo:in_data
	wire          lcd_data_s1_agent_rdata_fifo_src_ready;                                             // LCD_DATA_s1_agent_rdata_fifo:in_ready -> LCD_DATA_s1_agent:rdata_fifo_src_ready
	wire   [31:0] lcd_clk_s1_agent_m0_readdata;                                                       // LCD_CLK_s1_translator:uav_readdata -> LCD_CLK_s1_agent:m0_readdata
	wire          lcd_clk_s1_agent_m0_waitrequest;                                                    // LCD_CLK_s1_translator:uav_waitrequest -> LCD_CLK_s1_agent:m0_waitrequest
	wire          lcd_clk_s1_agent_m0_debugaccess;                                                    // LCD_CLK_s1_agent:m0_debugaccess -> LCD_CLK_s1_translator:uav_debugaccess
	wire   [31:0] lcd_clk_s1_agent_m0_address;                                                        // LCD_CLK_s1_agent:m0_address -> LCD_CLK_s1_translator:uav_address
	wire    [3:0] lcd_clk_s1_agent_m0_byteenable;                                                     // LCD_CLK_s1_agent:m0_byteenable -> LCD_CLK_s1_translator:uav_byteenable
	wire          lcd_clk_s1_agent_m0_read;                                                           // LCD_CLK_s1_agent:m0_read -> LCD_CLK_s1_translator:uav_read
	wire          lcd_clk_s1_agent_m0_readdatavalid;                                                  // LCD_CLK_s1_translator:uav_readdatavalid -> LCD_CLK_s1_agent:m0_readdatavalid
	wire          lcd_clk_s1_agent_m0_lock;                                                           // LCD_CLK_s1_agent:m0_lock -> LCD_CLK_s1_translator:uav_lock
	wire   [31:0] lcd_clk_s1_agent_m0_writedata;                                                      // LCD_CLK_s1_agent:m0_writedata -> LCD_CLK_s1_translator:uav_writedata
	wire          lcd_clk_s1_agent_m0_write;                                                          // LCD_CLK_s1_agent:m0_write -> LCD_CLK_s1_translator:uav_write
	wire    [2:0] lcd_clk_s1_agent_m0_burstcount;                                                     // LCD_CLK_s1_agent:m0_burstcount -> LCD_CLK_s1_translator:uav_burstcount
	wire          lcd_clk_s1_agent_rf_source_valid;                                                   // LCD_CLK_s1_agent:rf_source_valid -> LCD_CLK_s1_agent_rsp_fifo:in_valid
	wire  [131:0] lcd_clk_s1_agent_rf_source_data;                                                    // LCD_CLK_s1_agent:rf_source_data -> LCD_CLK_s1_agent_rsp_fifo:in_data
	wire          lcd_clk_s1_agent_rf_source_ready;                                                   // LCD_CLK_s1_agent_rsp_fifo:in_ready -> LCD_CLK_s1_agent:rf_source_ready
	wire          lcd_clk_s1_agent_rf_source_startofpacket;                                           // LCD_CLK_s1_agent:rf_source_startofpacket -> LCD_CLK_s1_agent_rsp_fifo:in_startofpacket
	wire          lcd_clk_s1_agent_rf_source_endofpacket;                                             // LCD_CLK_s1_agent:rf_source_endofpacket -> LCD_CLK_s1_agent_rsp_fifo:in_endofpacket
	wire          lcd_clk_s1_agent_rsp_fifo_out_valid;                                                // LCD_CLK_s1_agent_rsp_fifo:out_valid -> LCD_CLK_s1_agent:rf_sink_valid
	wire  [131:0] lcd_clk_s1_agent_rsp_fifo_out_data;                                                 // LCD_CLK_s1_agent_rsp_fifo:out_data -> LCD_CLK_s1_agent:rf_sink_data
	wire          lcd_clk_s1_agent_rsp_fifo_out_ready;                                                // LCD_CLK_s1_agent:rf_sink_ready -> LCD_CLK_s1_agent_rsp_fifo:out_ready
	wire          lcd_clk_s1_agent_rsp_fifo_out_startofpacket;                                        // LCD_CLK_s1_agent_rsp_fifo:out_startofpacket -> LCD_CLK_s1_agent:rf_sink_startofpacket
	wire          lcd_clk_s1_agent_rsp_fifo_out_endofpacket;                                          // LCD_CLK_s1_agent_rsp_fifo:out_endofpacket -> LCD_CLK_s1_agent:rf_sink_endofpacket
	wire          lcd_clk_s1_agent_rdata_fifo_src_valid;                                              // LCD_CLK_s1_agent:rdata_fifo_src_valid -> LCD_CLK_s1_agent_rdata_fifo:in_valid
	wire   [33:0] lcd_clk_s1_agent_rdata_fifo_src_data;                                               // LCD_CLK_s1_agent:rdata_fifo_src_data -> LCD_CLK_s1_agent_rdata_fifo:in_data
	wire          lcd_clk_s1_agent_rdata_fifo_src_ready;                                              // LCD_CLK_s1_agent_rdata_fifo:in_ready -> LCD_CLK_s1_agent:rdata_fifo_src_ready
	wire   [31:0] cam_wr_en_s1_agent_m0_readdata;                                                     // CAM_WR_EN_s1_translator:uav_readdata -> CAM_WR_EN_s1_agent:m0_readdata
	wire          cam_wr_en_s1_agent_m0_waitrequest;                                                  // CAM_WR_EN_s1_translator:uav_waitrequest -> CAM_WR_EN_s1_agent:m0_waitrequest
	wire          cam_wr_en_s1_agent_m0_debugaccess;                                                  // CAM_WR_EN_s1_agent:m0_debugaccess -> CAM_WR_EN_s1_translator:uav_debugaccess
	wire   [31:0] cam_wr_en_s1_agent_m0_address;                                                      // CAM_WR_EN_s1_agent:m0_address -> CAM_WR_EN_s1_translator:uav_address
	wire    [3:0] cam_wr_en_s1_agent_m0_byteenable;                                                   // CAM_WR_EN_s1_agent:m0_byteenable -> CAM_WR_EN_s1_translator:uav_byteenable
	wire          cam_wr_en_s1_agent_m0_read;                                                         // CAM_WR_EN_s1_agent:m0_read -> CAM_WR_EN_s1_translator:uav_read
	wire          cam_wr_en_s1_agent_m0_readdatavalid;                                                // CAM_WR_EN_s1_translator:uav_readdatavalid -> CAM_WR_EN_s1_agent:m0_readdatavalid
	wire          cam_wr_en_s1_agent_m0_lock;                                                         // CAM_WR_EN_s1_agent:m0_lock -> CAM_WR_EN_s1_translator:uav_lock
	wire   [31:0] cam_wr_en_s1_agent_m0_writedata;                                                    // CAM_WR_EN_s1_agent:m0_writedata -> CAM_WR_EN_s1_translator:uav_writedata
	wire          cam_wr_en_s1_agent_m0_write;                                                        // CAM_WR_EN_s1_agent:m0_write -> CAM_WR_EN_s1_translator:uav_write
	wire    [2:0] cam_wr_en_s1_agent_m0_burstcount;                                                   // CAM_WR_EN_s1_agent:m0_burstcount -> CAM_WR_EN_s1_translator:uav_burstcount
	wire          cam_wr_en_s1_agent_rf_source_valid;                                                 // CAM_WR_EN_s1_agent:rf_source_valid -> CAM_WR_EN_s1_agent_rsp_fifo:in_valid
	wire  [131:0] cam_wr_en_s1_agent_rf_source_data;                                                  // CAM_WR_EN_s1_agent:rf_source_data -> CAM_WR_EN_s1_agent_rsp_fifo:in_data
	wire          cam_wr_en_s1_agent_rf_source_ready;                                                 // CAM_WR_EN_s1_agent_rsp_fifo:in_ready -> CAM_WR_EN_s1_agent:rf_source_ready
	wire          cam_wr_en_s1_agent_rf_source_startofpacket;                                         // CAM_WR_EN_s1_agent:rf_source_startofpacket -> CAM_WR_EN_s1_agent_rsp_fifo:in_startofpacket
	wire          cam_wr_en_s1_agent_rf_source_endofpacket;                                           // CAM_WR_EN_s1_agent:rf_source_endofpacket -> CAM_WR_EN_s1_agent_rsp_fifo:in_endofpacket
	wire          cam_wr_en_s1_agent_rsp_fifo_out_valid;                                              // CAM_WR_EN_s1_agent_rsp_fifo:out_valid -> CAM_WR_EN_s1_agent:rf_sink_valid
	wire  [131:0] cam_wr_en_s1_agent_rsp_fifo_out_data;                                               // CAM_WR_EN_s1_agent_rsp_fifo:out_data -> CAM_WR_EN_s1_agent:rf_sink_data
	wire          cam_wr_en_s1_agent_rsp_fifo_out_ready;                                              // CAM_WR_EN_s1_agent:rf_sink_ready -> CAM_WR_EN_s1_agent_rsp_fifo:out_ready
	wire          cam_wr_en_s1_agent_rsp_fifo_out_startofpacket;                                      // CAM_WR_EN_s1_agent_rsp_fifo:out_startofpacket -> CAM_WR_EN_s1_agent:rf_sink_startofpacket
	wire          cam_wr_en_s1_agent_rsp_fifo_out_endofpacket;                                        // CAM_WR_EN_s1_agent_rsp_fifo:out_endofpacket -> CAM_WR_EN_s1_agent:rf_sink_endofpacket
	wire          cam_wr_en_s1_agent_rdata_fifo_src_valid;                                            // CAM_WR_EN_s1_agent:rdata_fifo_src_valid -> CAM_WR_EN_s1_agent_rdata_fifo:in_valid
	wire   [33:0] cam_wr_en_s1_agent_rdata_fifo_src_data;                                             // CAM_WR_EN_s1_agent:rdata_fifo_src_data -> CAM_WR_EN_s1_agent_rdata_fifo:in_data
	wire          cam_wr_en_s1_agent_rdata_fifo_src_ready;                                            // CAM_WR_EN_s1_agent_rdata_fifo:in_ready -> CAM_WR_EN_s1_agent:rdata_fifo_src_ready
	wire   [31:0] cam_frame_num_s1_agent_m0_readdata;                                                 // CAM_FRAME_NUM_s1_translator:uav_readdata -> CAM_FRAME_NUM_s1_agent:m0_readdata
	wire          cam_frame_num_s1_agent_m0_waitrequest;                                              // CAM_FRAME_NUM_s1_translator:uav_waitrequest -> CAM_FRAME_NUM_s1_agent:m0_waitrequest
	wire          cam_frame_num_s1_agent_m0_debugaccess;                                              // CAM_FRAME_NUM_s1_agent:m0_debugaccess -> CAM_FRAME_NUM_s1_translator:uav_debugaccess
	wire   [31:0] cam_frame_num_s1_agent_m0_address;                                                  // CAM_FRAME_NUM_s1_agent:m0_address -> CAM_FRAME_NUM_s1_translator:uav_address
	wire    [3:0] cam_frame_num_s1_agent_m0_byteenable;                                               // CAM_FRAME_NUM_s1_agent:m0_byteenable -> CAM_FRAME_NUM_s1_translator:uav_byteenable
	wire          cam_frame_num_s1_agent_m0_read;                                                     // CAM_FRAME_NUM_s1_agent:m0_read -> CAM_FRAME_NUM_s1_translator:uav_read
	wire          cam_frame_num_s1_agent_m0_readdatavalid;                                            // CAM_FRAME_NUM_s1_translator:uav_readdatavalid -> CAM_FRAME_NUM_s1_agent:m0_readdatavalid
	wire          cam_frame_num_s1_agent_m0_lock;                                                     // CAM_FRAME_NUM_s1_agent:m0_lock -> CAM_FRAME_NUM_s1_translator:uav_lock
	wire   [31:0] cam_frame_num_s1_agent_m0_writedata;                                                // CAM_FRAME_NUM_s1_agent:m0_writedata -> CAM_FRAME_NUM_s1_translator:uav_writedata
	wire          cam_frame_num_s1_agent_m0_write;                                                    // CAM_FRAME_NUM_s1_agent:m0_write -> CAM_FRAME_NUM_s1_translator:uav_write
	wire    [2:0] cam_frame_num_s1_agent_m0_burstcount;                                               // CAM_FRAME_NUM_s1_agent:m0_burstcount -> CAM_FRAME_NUM_s1_translator:uav_burstcount
	wire          cam_frame_num_s1_agent_rf_source_valid;                                             // CAM_FRAME_NUM_s1_agent:rf_source_valid -> CAM_FRAME_NUM_s1_agent_rsp_fifo:in_valid
	wire  [131:0] cam_frame_num_s1_agent_rf_source_data;                                              // CAM_FRAME_NUM_s1_agent:rf_source_data -> CAM_FRAME_NUM_s1_agent_rsp_fifo:in_data
	wire          cam_frame_num_s1_agent_rf_source_ready;                                             // CAM_FRAME_NUM_s1_agent_rsp_fifo:in_ready -> CAM_FRAME_NUM_s1_agent:rf_source_ready
	wire          cam_frame_num_s1_agent_rf_source_startofpacket;                                     // CAM_FRAME_NUM_s1_agent:rf_source_startofpacket -> CAM_FRAME_NUM_s1_agent_rsp_fifo:in_startofpacket
	wire          cam_frame_num_s1_agent_rf_source_endofpacket;                                       // CAM_FRAME_NUM_s1_agent:rf_source_endofpacket -> CAM_FRAME_NUM_s1_agent_rsp_fifo:in_endofpacket
	wire          cam_frame_num_s1_agent_rsp_fifo_out_valid;                                          // CAM_FRAME_NUM_s1_agent_rsp_fifo:out_valid -> CAM_FRAME_NUM_s1_agent:rf_sink_valid
	wire  [131:0] cam_frame_num_s1_agent_rsp_fifo_out_data;                                           // CAM_FRAME_NUM_s1_agent_rsp_fifo:out_data -> CAM_FRAME_NUM_s1_agent:rf_sink_data
	wire          cam_frame_num_s1_agent_rsp_fifo_out_ready;                                          // CAM_FRAME_NUM_s1_agent:rf_sink_ready -> CAM_FRAME_NUM_s1_agent_rsp_fifo:out_ready
	wire          cam_frame_num_s1_agent_rsp_fifo_out_startofpacket;                                  // CAM_FRAME_NUM_s1_agent_rsp_fifo:out_startofpacket -> CAM_FRAME_NUM_s1_agent:rf_sink_startofpacket
	wire          cam_frame_num_s1_agent_rsp_fifo_out_endofpacket;                                    // CAM_FRAME_NUM_s1_agent_rsp_fifo:out_endofpacket -> CAM_FRAME_NUM_s1_agent:rf_sink_endofpacket
	wire          cam_frame_num_s1_agent_rdata_fifo_src_valid;                                        // CAM_FRAME_NUM_s1_agent:rdata_fifo_src_valid -> CAM_FRAME_NUM_s1_agent_rdata_fifo:in_valid
	wire   [33:0] cam_frame_num_s1_agent_rdata_fifo_src_data;                                         // CAM_FRAME_NUM_s1_agent:rdata_fifo_src_data -> CAM_FRAME_NUM_s1_agent_rdata_fifo:in_data
	wire          cam_frame_num_s1_agent_rdata_fifo_src_ready;                                        // CAM_FRAME_NUM_s1_agent_rdata_fifo:in_ready -> CAM_FRAME_NUM_s1_agent:rdata_fifo_src_ready
	...
	wire          sda_s1_agent_rp_valid;                                                              // SDA_s1_agent:rp_valid -> router_010:sink_valid
	wire  [130:0] sda_s1_agent_rp_data;                                                               // SDA_s1_agent:rp_data -> router_010:sink_data
	wire          sda_s1_agent_rp_ready;                                                              // router_010:sink_ready -> SDA_s1_agent:rp_ready
	wire          sda_s1_agent_rp_startofpacket;                                                      // SDA_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          sda_s1_agent_rp_endofpacket;                                                        // SDA_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          scl_s1_agent_rp_valid;                                                              // SCL_s1_agent:rp_valid -> router_011:sink_valid
	wire  [130:0] scl_s1_agent_rp_data;                                                               // SCL_s1_agent:rp_data -> router_011:sink_data
	wire          scl_s1_agent_rp_ready;                                                              // router_011:sink_ready -> SCL_s1_agent:rp_ready
	wire          scl_s1_agent_rp_startofpacket;                                                      // SCL_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          scl_s1_agent_rp_endofpacket;                                                        // SCL_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [130:0] lcd_data_s1_agent_rp_data;                                                          // LCD_DATA_s1_agent:rp_data -> router_012:sink_data
	...
	wire          lcd_clk_s1_agent_rp_valid;                                                          // LCD_CLK_s1_agent:rp_valid -> router_013:sink_valid
	wire  [130:0] lcd_clk_s1_agent_rp_data;                                                           // LCD_CLK_s1_agent:rp_data -> router_013:sink_data
	wire          lcd_clk_s1_agent_rp_ready;                                                          // router_013:sink_ready -> LCD_CLK_s1_agent:rp_ready
	wire          lcd_clk_s1_agent_rp_startofpacket;                                                  // LCD_CLK_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          lcd_clk_s1_agent_rp_endofpacket;                                                    // LCD_CLK_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          cam_wr_en_s1_agent_rp_valid;                                                        // CAM_WR_EN_s1_agent:rp_valid -> router_014:sink_valid
	wire  [130:0] cam_wr_en_s1_agent_rp_data;                                                         // CAM_WR_EN_s1_agent:rp_data -> router_014:sink_data
	wire          cam_wr_en_s1_agent_rp_ready;                                                        // router_014:sink_ready -> CAM_WR_EN_s1_agent:rp_ready
	wire          cam_wr_en_s1_agent_rp_startofpacket;                                                // CAM_WR_EN_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          cam_wr_en_s1_agent_rp_endofpacket;                                                  // CAM_WR_EN_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          cam_frame_num_s1_agent_rp_valid;                                                    // CAM_FRAME_NUM_s1_agent:rp_valid -> router_015:sink_valid
	wire  [130:0] cam_frame_num_s1_agent_rp_data;                                                     // CAM_FRAME_NUM_s1_agent:rp_data -> router_015:sink_data
	wire          cam_frame_num_s1_agent_rp_ready;                                                    // router_015:sink_ready -> CAM_FRAME_NUM_s1_agent:rp_ready
	wire          cam_frame_num_s1_agent_rp_startofpacket;                                            // CAM_FRAME_NUM_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          cam_frame_num_s1_agent_rp_endofpacket;                                              // CAM_FRAME_NUM_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> SDA_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> SDA_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                              // SDA_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire   [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SDA_s1_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> SDA_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> SDA_s1_burst_adapter:sink0_endofpacket
	wire          sda_s1_burst_adapter_source0_valid;                                                 // SDA_s1_burst_adapter:source0_valid -> SDA_s1_agent:cp_valid
	wire  [130:0] sda_s1_burst_adapter_source0_data;                                                  // SDA_s1_burst_adapter:source0_data -> SDA_s1_agent:cp_data
	wire          sda_s1_burst_adapter_source0_ready;                                                 // SDA_s1_agent:cp_ready -> SDA_s1_burst_adapter:source0_ready
	wire   [10:0] sda_s1_burst_adapter_source0_channel;                                               // SDA_s1_burst_adapter:source0_channel -> SDA_s1_agent:cp_channel
	wire          sda_s1_burst_adapter_source0_startofpacket;                                         // SDA_s1_burst_adapter:source0_startofpacket -> SDA_s1_agent:cp_startofpacket
	wire          sda_s1_burst_adapter_source0_endofpacket;                                           // SDA_s1_burst_adapter:source0_endofpacket -> SDA_s1_agent:cp_endofpacket
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> SCL_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> SCL_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                              // SCL_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire   [10:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> SCL_s1_burst_adapter:sink0_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> SCL_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> SCL_s1_burst_adapter:sink0_endofpacket
	wire          scl_s1_burst_adapter_source0_valid;                                                 // SCL_s1_burst_adapter:source0_valid -> SCL_s1_agent:cp_valid
	wire  [130:0] scl_s1_burst_adapter_source0_data;                                                  // SCL_s1_burst_adapter:source0_data -> SCL_s1_agent:cp_data
	wire          scl_s1_burst_adapter_source0_ready;                                                 // SCL_s1_agent:cp_ready -> SCL_s1_burst_adapter:source0_ready
	wire   [10:0] scl_s1_burst_adapter_source0_channel;                                               // SCL_s1_burst_adapter:source0_channel -> SCL_s1_agent:cp_channel
	wire          scl_s1_burst_adapter_source0_startofpacket;                                         // SCL_s1_burst_adapter:source0_startofpacket -> SCL_s1_agent:cp_startofpacket
	wire          scl_s1_burst_adapter_source0_endofpacket;                                           // SCL_s1_burst_adapter:source0_endofpacket -> SCL_s1_agent:cp_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> LCD_DATA_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> LCD_DATA_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                              // LCD_DATA_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire   [10:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> LCD_DATA_s1_burst_adapter:sink0_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> LCD_DATA_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> LCD_DATA_s1_burst_adapter:sink0_endofpacket
	wire          lcd_data_s1_burst_adapter_source0_valid;                                            // LCD_DATA_s1_burst_adapter:source0_valid -> LCD_DATA_s1_agent:cp_valid
	wire  [130:0] lcd_data_s1_burst_adapter_source0_data;                                             // LCD_DATA_s1_burst_adapter:source0_data -> LCD_DATA_s1_agent:cp_data
	wire          lcd_data_s1_burst_adapter_source0_ready;                                            // LCD_DATA_s1_agent:cp_ready -> LCD_DATA_s1_burst_adapter:source0_ready
	wire   [10:0] lcd_data_s1_burst_adapter_source0_channel;                                          // LCD_DATA_s1_burst_adapter:source0_channel -> LCD_DATA_s1_agent:cp_channel
	wire          lcd_data_s1_burst_adapter_source0_startofpacket;                                    // LCD_DATA_s1_burst_adapter:source0_startofpacket -> LCD_DATA_s1_agent:cp_startofpacket
	wire          lcd_data_s1_burst_adapter_source0_endofpacket;                                      // LCD_DATA_s1_burst_adapter:source0_endofpacket -> LCD_DATA_s1_agent:cp_endofpacket
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> LCD_CLK_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> LCD_CLK_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                              // LCD_CLK_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire   [10:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> LCD_CLK_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> LCD_CLK_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> LCD_CLK_s1_burst_adapter:sink0_endofpacket
	wire          lcd_clk_s1_burst_adapter_source0_valid;                                             // LCD_CLK_s1_burst_adapter:source0_valid -> LCD_CLK_s1_agent:cp_valid
	wire  [130:0] lcd_clk_s1_burst_adapter_source0_data;                                              // LCD_CLK_s1_burst_adapter:source0_data -> LCD_CLK_s1_agent:cp_data
	wire          lcd_clk_s1_burst_adapter_source0_ready;                                             // LCD_CLK_s1_agent:cp_ready -> LCD_CLK_s1_burst_adapter:source0_ready
	wire   [10:0] lcd_clk_s1_burst_adapter_source0_channel;                                           // LCD_CLK_s1_burst_adapter:source0_channel -> LCD_CLK_s1_agent:cp_channel
	wire          lcd_clk_s1_burst_adapter_source0_startofpacket;                                     // LCD_CLK_s1_burst_adapter:source0_startofpacket -> LCD_CLK_s1_agent:cp_startofpacket
	wire          lcd_clk_s1_burst_adapter_source0_endofpacket;                                       // LCD_CLK_s1_burst_adapter:source0_endofpacket -> LCD_CLK_s1_agent:cp_endofpacket
	wire          cmd_mux_009_src_valid;                                                              // cmd_mux_009:src_valid -> CAM_WR_EN_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> CAM_WR_EN_s1_burst_adapter:sink0_data
	wire          cmd_mux_009_src_ready;                                                              // CAM_WR_EN_s1_burst_adapter:sink0_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> CAM_WR_EN_s1_burst_adapter:sink0_channel
	wire          cmd_mux_009_src_startofpacket;                                                      // cmd_mux_009:src_startofpacket -> CAM_WR_EN_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                        // cmd_mux_009:src_endofpacket -> CAM_WR_EN_s1_burst_adapter:sink0_endofpacket
	wire          cam_wr_en_s1_burst_adapter_source0_valid;                                           // CAM_WR_EN_s1_burst_adapter:source0_valid -> CAM_WR_EN_s1_agent:cp_valid
	wire  [130:0] cam_wr_en_s1_burst_adapter_source0_data;                                            // CAM_WR_EN_s1_burst_adapter:source0_data -> CAM_WR_EN_s1_agent:cp_data
	wire          cam_wr_en_s1_burst_adapter_source0_ready;                                           // CAM_WR_EN_s1_agent:cp_ready -> CAM_WR_EN_s1_burst_adapter:source0_ready
	wire   [10:0] cam_wr_en_s1_burst_adapter_source0_channel;                                         // CAM_WR_EN_s1_burst_adapter:source0_channel -> CAM_WR_EN_s1_agent:cp_channel
	wire          cam_wr_en_s1_burst_adapter_source0_startofpacket;                                   // CAM_WR_EN_s1_burst_adapter:source0_startofpacket -> CAM_WR_EN_s1_agent:cp_startofpacket
	wire          cam_wr_en_s1_burst_adapter_source0_endofpacket;                                     // CAM_WR_EN_s1_burst_adapter:source0_endofpacket -> CAM_WR_EN_s1_agent:cp_endofpacket
	wire          cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> CAM_FRAME_NUM_s1_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> CAM_FRAME_NUM_s1_burst_adapter:sink0_data
	wire          cmd_mux_010_src_ready;                                                              // CAM_FRAME_NUM_s1_burst_adapter:sink0_ready -> cmd_mux_010:src_ready
	wire   [10:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> CAM_FRAME_NUM_s1_burst_adapter:sink0_channel
	wire          cmd_mux_010_src_startofpacket;                                                      // cmd_mux_010:src_startofpacket -> CAM_FRAME_NUM_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                        // cmd_mux_010:src_endofpacket -> CAM_FRAME_NUM_s1_burst_adapter:sink0_endofpacket
	wire          cam_frame_num_s1_burst_adapter_source0_valid;                                       // CAM_FRAME_NUM_s1_burst_adapter:source0_valid -> CAM_FRAME_NUM_s1_agent:cp_valid
	wire  [130:0] cam_frame_num_s1_burst_adapter_source0_data;                                        // CAM_FRAME_NUM_s1_burst_adapter:source0_data -> CAM_FRAME_NUM_s1_agent:cp_data
	wire          cam_frame_num_s1_burst_adapter_source0_ready;                                       // CAM_FRAME_NUM_s1_agent:cp_ready -> CAM_FRAME_NUM_s1_burst_adapter:source0_ready
	wire   [10:0] cam_frame_num_s1_burst_adapter_source0_channel;                                     // CAM_FRAME_NUM_s1_burst_adapter:source0_channel -> CAM_FRAME_NUM_s1_agent:cp_channel
	wire          cam_frame_num_s1_burst_adapter_source0_startofpacket;                               // CAM_FRAME_NUM_s1_burst_adapter:source0_startofpacket -> CAM_FRAME_NUM_s1_agent:cp_startofpacket
	wire          cam_frame_num_s1_burst_adapter_source0_endofpacket;                                 // CAM_FRAME_NUM_s1_burst_adapter:source0_endofpacket -> CAM_FRAME_NUM_s1_agent:cp_endofpacket
	...
	wire          sda_s1_agent_rdata_fifo_out_valid;                                                  // SDA_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] sda_s1_agent_rdata_fifo_out_data;                                                   // SDA_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          sda_s1_agent_rdata_fifo_out_ready;                                                  // avalon_st_adapter_005:in_0_ready -> SDA_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> SDA_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> SDA_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // SDA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> SDA_s1_agent:rdata_fifo_sink_error
	wire          scl_s1_agent_rdata_fifo_out_valid;                                                  // SCL_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] scl_s1_agent_rdata_fifo_out_data;                                                   // SCL_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_006:in_0_data
	wire          scl_s1_agent_rdata_fifo_out_ready;                                                  // avalon_st_adapter_006:in_0_ready -> SCL_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> SCL_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> SCL_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // SCL_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> SCL_s1_agent:rdata_fifo_sink_error
	wire          lcd_data_s1_agent_rdata_fifo_out_valid;                                             // LCD_DATA_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] lcd_data_s1_agent_rdata_fifo_out_data;                                              // LCD_DATA_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          lcd_data_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_007:in_0_ready -> LCD_DATA_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> LCD_DATA_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> LCD_DATA_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // LCD_DATA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> LCD_DATA_s1_agent:rdata_fifo_sink_error
	wire          lcd_clk_s1_agent_rdata_fifo_out_valid;                                              // LCD_CLK_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] lcd_clk_s1_agent_rdata_fifo_out_data;                                               // LCD_CLK_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          lcd_clk_s1_agent_rdata_fifo_out_ready;                                              // avalon_st_adapter_008:in_0_ready -> LCD_CLK_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> LCD_CLK_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> LCD_CLK_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // LCD_CLK_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> LCD_CLK_s1_agent:rdata_fifo_sink_error
	wire          cam_wr_en_s1_agent_rdata_fifo_out_valid;                                            // CAM_WR_EN_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] cam_wr_en_s1_agent_rdata_fifo_out_data;                                             // CAM_WR_EN_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          cam_wr_en_s1_agent_rdata_fifo_out_ready;                                            // avalon_st_adapter_009:in_0_ready -> CAM_WR_EN_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                  // avalon_st_adapter_009:out_0_valid -> CAM_WR_EN_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                   // avalon_st_adapter_009:out_0_data -> CAM_WR_EN_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                  // CAM_WR_EN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                  // avalon_st_adapter_009:out_0_error -> CAM_WR_EN_s1_agent:rdata_fifo_sink_error
	wire          cam_frame_num_s1_agent_rdata_fifo_out_valid;                                        // CAM_FRAME_NUM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] cam_frame_num_s1_agent_rdata_fifo_out_data;                                         // CAM_FRAME_NUM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_010:in_0_data
	wire          cam_frame_num_s1_agent_rdata_fifo_out_ready;                                        // avalon_st_adapter_010:in_0_ready -> CAM_FRAME_NUM_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_010_out_0_valid;                                                  // avalon_st_adapter_010:out_0_valid -> CAM_FRAME_NUM_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                   // avalon_st_adapter_010:out_0_data -> CAM_FRAME_NUM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                                  // CAM_FRAME_NUM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                                  // avalon_st_adapter_010:out_0_error -> CAM_FRAME_NUM_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) lcd_clk_s1_translator (
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lcd_clk_s1_agent_m0_address),                         // avalon_universal_slave_0.address
		.uav_burstcount         (lcd_clk_s1_agent_m0_burstcount),                      //                         .burstcount
		.uav_read               (lcd_clk_s1_agent_m0_read),                            //                         .read
		.uav_write              (lcd_clk_s1_agent_m0_write),                           //                         .write
		.uav_waitrequest        (lcd_clk_s1_agent_m0_waitrequest),                     //                         .waitrequest
		.uav_readdatavalid      (lcd_clk_s1_agent_m0_readdatavalid),                   //                         .readdatavalid
		.uav_byteenable         (lcd_clk_s1_agent_m0_byteenable),                      //                         .byteenable
		.uav_readdata           (lcd_clk_s1_agent_m0_readdata),                        //                         .readdata
		.uav_writedata          (lcd_clk_s1_agent_m0_writedata),                       //                         .writedata
		.uav_lock               (lcd_clk_s1_agent_m0_lock),                            //                         .lock
		.uav_debugaccess        (lcd_clk_s1_agent_m0_debugaccess),                     //                         .debugaccess
		.av_address             (LCD_CLK_s1_address),                                  //      avalon_anti_slave_0.address
		.av_write               (LCD_CLK_s1_write),                                    //                         .write
		.av_readdata            (LCD_CLK_s1_readdata),                                 //                         .readdata
		.av_writedata           (LCD_CLK_s1_writedata),                                //                         .writedata
		.av_chipselect          (LCD_CLK_s1_chipselect),                               //                         .chipselect
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) cam_wr_en_s1_translator (
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cam_wr_en_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (cam_wr_en_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (cam_wr_en_s1_agent_m0_read),                          //                         .read
		.uav_write              (cam_wr_en_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (cam_wr_en_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (cam_wr_en_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (cam_wr_en_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (cam_wr_en_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (cam_wr_en_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (cam_wr_en_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (cam_wr_en_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (CAM_WR_EN_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (CAM_WR_EN_s1_write),                                  //                         .write
		.av_readdata            (CAM_WR_EN_s1_readdata),                               //                         .readdata
		.av_writedata           (CAM_WR_EN_s1_writedata),                              //                         .writedata
		.av_chipselect          (CAM_WR_EN_s1_chipselect),                             //                         .chipselect
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) cam_frame_num_s1_translator (
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cam_frame_num_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (cam_frame_num_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (cam_frame_num_s1_agent_m0_read),                      //                         .read
		.uav_write              (cam_frame_num_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (cam_frame_num_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (cam_frame_num_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (cam_frame_num_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (cam_frame_num_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (cam_frame_num_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (cam_frame_num_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (cam_frame_num_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (CAM_FRAME_NUM_s1_address),                            //      avalon_anti_slave_0.address
		.av_readdata            (CAM_FRAME_NUM_s1_readdata),                           //                         .readdata
		.av_write               (),                                                    //              (terminated)
		.av_read                (),                                                    //              (terminated)
		.av_writedata           (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (sda_s1_burst_adapter_source0_ready),                  //              cp.ready
		.cp_valid                (sda_s1_burst_adapter_source0_valid),                  //                .valid
		.cp_data                 (sda_s1_burst_adapter_source0_data),                   //                .data
		.cp_startofpacket        (sda_s1_burst_adapter_source0_startofpacket),          //                .startofpacket
		.cp_endofpacket          (sda_s1_burst_adapter_source0_endofpacket),            //                .endofpacket
		.cp_channel              (sda_s1_burst_adapter_source0_channel),                //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sda_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sda_s1_agent_rdata_fifo_src_data),                    //        in.data
		.in_valid          (sda_s1_agent_rdata_fifo_src_valid),                   //          .valid
		.in_ready          (sda_s1_agent_rdata_fifo_src_ready),                   //          .ready
		.out_data          (sda_s1_agent_rdata_fifo_out_data),                    //       out.data
		.out_valid         (sda_s1_agent_rdata_fifo_out_valid),                   //          .valid
		.out_ready         (sda_s1_agent_rdata_fifo_out_ready),                   //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (scl_s1_burst_adapter_source0_ready),                  //              cp.ready
		.cp_valid                (scl_s1_burst_adapter_source0_valid),                  //                .valid
		.cp_data                 (scl_s1_burst_adapter_source0_data),                   //                .data
		.cp_startofpacket        (scl_s1_burst_adapter_source0_startofpacket),          //                .startofpacket
		.cp_endofpacket          (scl_s1_burst_adapter_source0_endofpacket),            //                .endofpacket
		.cp_channel              (scl_s1_burst_adapter_source0_channel),                //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) scl_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (scl_s1_agent_rdata_fifo_src_data),                    //        in.data
		.in_valid          (scl_s1_agent_rdata_fifo_src_valid),                   //          .valid
		.in_ready          (scl_s1_agent_rdata_fifo_src_ready),                   //          .ready
		.out_data          (scl_s1_agent_rdata_fifo_out_data),                    //       out.data
		.out_valid         (scl_s1_agent_rdata_fifo_out_valid),                   //          .valid
		.out_ready         (scl_s1_agent_rdata_fifo_out_ready),                   //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (lcd_data_s1_burst_adapter_source0_ready),             //              cp.ready
		.cp_valid                (lcd_data_s1_burst_adapter_source0_valid),             //                .valid
		.cp_data                 (lcd_data_s1_burst_adapter_source0_data),              //                .data
		.cp_startofpacket        (lcd_data_s1_burst_adapter_source0_startofpacket),     //                .startofpacket
		.cp_endofpacket          (lcd_data_s1_burst_adapter_source0_endofpacket),       //                .endofpacket
		.cp_channel              (lcd_data_s1_burst_adapter_source0_channel),           //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_data_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (lcd_data_s1_agent_rdata_fifo_src_data),               //        in.data
		.in_valid          (lcd_data_s1_agent_rdata_fifo_src_valid),              //          .valid
		.in_ready          (lcd_data_s1_agent_rdata_fifo_src_ready),              //          .ready
		.out_data          (lcd_data_s1_agent_rdata_fifo_out_data),               //       out.data
		.out_valid         (lcd_data_s1_agent_rdata_fifo_out_valid),              //          .valid
		.out_ready         (lcd_data_s1_agent_rdata_fifo_out_ready),              //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (lcd_clk_s1_agent_m0_address),                         //              m0.address
		.m0_burstcount           (lcd_clk_s1_agent_m0_burstcount),                      //                .burstcount
		.m0_byteenable           (lcd_clk_s1_agent_m0_byteenable),                      //                .byteenable
		.m0_debugaccess          (lcd_clk_s1_agent_m0_debugaccess),                     //                .debugaccess
		.m0_lock                 (lcd_clk_s1_agent_m0_lock),                            //                .lock
		.m0_readdata             (lcd_clk_s1_agent_m0_readdata),                        //                .readdata
		.m0_readdatavalid        (lcd_clk_s1_agent_m0_readdatavalid),                   //                .readdatavalid
		.m0_read                 (lcd_clk_s1_agent_m0_read),                            //                .read
		.m0_waitrequest          (lcd_clk_s1_agent_m0_waitrequest),                     //                .waitrequest
		.m0_writedata            (lcd_clk_s1_agent_m0_writedata),                       //                .writedata
		.m0_write                (lcd_clk_s1_agent_m0_write),                           //                .write
		.rp_endofpacket          (lcd_clk_s1_agent_rp_endofpacket),                     //              rp.endofpacket
		.rp_ready                (lcd_clk_s1_agent_rp_ready),                           //                .ready
		.rp_valid                (lcd_clk_s1_agent_rp_valid),                           //                .valid
		.rp_data                 (lcd_clk_s1_agent_rp_data),                            //                .data
		.rp_startofpacket        (lcd_clk_s1_agent_rp_startofpacket),                   //                .startofpacket
		.cp_ready                (lcd_clk_s1_burst_adapter_source0_ready),              //              cp.ready
		.cp_valid                (lcd_clk_s1_burst_adapter_source0_valid),              //                .valid
		.cp_data                 (lcd_clk_s1_burst_adapter_source0_data),               //                .data
		.cp_startofpacket        (lcd_clk_s1_burst_adapter_source0_startofpacket),      //                .startofpacket
		.cp_endofpacket          (lcd_clk_s1_burst_adapter_source0_endofpacket),        //                .endofpacket
		.cp_channel              (lcd_clk_s1_burst_adapter_source0_channel),            //                .channel
		.rf_sink_ready           (lcd_clk_s1_agent_rsp_fifo_out_ready),                 //         rf_sink.ready
		.rf_sink_valid           (lcd_clk_s1_agent_rsp_fifo_out_valid),                 //                .valid
		.rf_sink_startofpacket   (lcd_clk_s1_agent_rsp_fifo_out_startofpacket),         //                .startofpacket
		.rf_sink_endofpacket     (lcd_clk_s1_agent_rsp_fifo_out_endofpacket),           //                .endofpacket
		.rf_sink_data            (lcd_clk_s1_agent_rsp_fifo_out_data),                  //                .data
		.rf_source_ready         (lcd_clk_s1_agent_rf_source_ready),                    //       rf_source.ready
		.rf_source_valid         (lcd_clk_s1_agent_rf_source_valid),                    //                .valid
		.rf_source_startofpacket (lcd_clk_s1_agent_rf_source_startofpacket),            //                .startofpacket
		.rf_source_endofpacket   (lcd_clk_s1_agent_rf_source_endofpacket),              //                .endofpacket
		.rf_source_data          (lcd_clk_s1_agent_rf_source_data),                     //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (lcd_clk_s1_agent_rdata_fifo_src_ready),               //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lcd_clk_s1_agent_rdata_fifo_src_valid),               //                .valid
		.rdata_fifo_src_data     (lcd_clk_s1_agent_rdata_fifo_src_data),                //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_clk_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (lcd_clk_s1_agent_rf_source_data),                     //        in.data
		.in_valid          (lcd_clk_s1_agent_rf_source_valid),                    //          .valid
		.in_ready          (lcd_clk_s1_agent_rf_source_ready),                    //          .ready
		.in_startofpacket  (lcd_clk_s1_agent_rf_source_startofpacket),            //          .startofpacket
		.in_endofpacket    (lcd_clk_s1_agent_rf_source_endofpacket),              //          .endofpacket
		.out_data          (lcd_clk_s1_agent_rsp_fifo_out_data),                  //       out.data
		.out_valid         (lcd_clk_s1_agent_rsp_fifo_out_valid),                 //          .valid
		.out_ready         (lcd_clk_s1_agent_rsp_fifo_out_ready),                 //          .ready
		.out_startofpacket (lcd_clk_s1_agent_rsp_fifo_out_startofpacket),         //          .startofpacket
		.out_endofpacket   (lcd_clk_s1_agent_rsp_fifo_out_endofpacket),           //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_clk_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (lcd_clk_s1_agent_rdata_fifo_src_data),                //        in.data
		.in_valid          (lcd_clk_s1_agent_rdata_fifo_src_valid),               //          .valid
		.in_ready          (lcd_clk_s1_agent_rdata_fifo_src_ready),               //          .ready
		.out_data          (lcd_clk_s1_agent_rdata_fifo_out_data),                //       out.data
		.out_valid         (lcd_clk_s1_agent_rdata_fifo_out_valid),               //          .valid
		.out_ready         (lcd_clk_s1_agent_rdata_fifo_out_ready),               //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (cam_wr_en_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (cam_wr_en_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (cam_wr_en_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (cam_wr_en_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (cam_wr_en_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (cam_wr_en_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (cam_wr_en_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (cam_wr_en_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (cam_wr_en_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (cam_wr_en_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (cam_wr_en_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (cam_wr_en_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (cam_wr_en_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (cam_wr_en_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (cam_wr_en_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (cam_wr_en_s1_agent_rp_startofpacket),                 //                .startofpacket
		.cp_ready                (cam_wr_en_s1_burst_adapter_source0_ready),            //              cp.ready
		.cp_valid                (cam_wr_en_s1_burst_adapter_source0_valid),            //                .valid
		.cp_data                 (cam_wr_en_s1_burst_adapter_source0_data),             //                .data
		.cp_startofpacket        (cam_wr_en_s1_burst_adapter_source0_startofpacket),    //                .startofpacket
		.cp_endofpacket          (cam_wr_en_s1_burst_adapter_source0_endofpacket),      //                .endofpacket
		.cp_channel              (cam_wr_en_s1_burst_adapter_source0_channel),          //                .channel
		.rf_sink_ready           (cam_wr_en_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (cam_wr_en_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (cam_wr_en_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (cam_wr_en_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (cam_wr_en_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (cam_wr_en_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (cam_wr_en_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (cam_wr_en_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (cam_wr_en_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (cam_wr_en_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_009_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_009_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_009_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_009_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (cam_wr_en_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cam_wr_en_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (cam_wr_en_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cam_wr_en_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cam_wr_en_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (cam_wr_en_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (cam_wr_en_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (cam_wr_en_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (cam_wr_en_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (cam_wr_en_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (cam_wr_en_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (cam_wr_en_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (cam_wr_en_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (cam_wr_en_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cam_wr_en_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cam_wr_en_s1_agent_rdata_fifo_src_data),              //        in.data
		.in_valid          (cam_wr_en_s1_agent_rdata_fifo_src_valid),             //          .valid
		.in_ready          (cam_wr_en_s1_agent_rdata_fifo_src_ready),             //          .ready
		.out_data          (cam_wr_en_s1_agent_rdata_fifo_out_data),              //       out.data
		.out_valid         (cam_wr_en_s1_agent_rdata_fifo_out_valid),             //          .valid
		.out_ready         (cam_wr_en_s1_agent_rdata_fifo_out_ready),             //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) cam_frame_num_s1_agent (
		.clk                     (clk_0_clk_clk),                                        //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (cam_frame_num_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (cam_frame_num_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (cam_frame_num_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (cam_frame_num_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (cam_frame_num_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (cam_frame_num_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (cam_frame_num_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (cam_frame_num_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (cam_frame_num_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (cam_frame_num_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (cam_frame_num_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (cam_frame_num_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (cam_frame_num_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (cam_frame_num_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (cam_frame_num_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (cam_frame_num_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (cam_frame_num_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (cam_frame_num_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (cam_frame_num_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (cam_frame_num_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (cam_frame_num_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (cam_frame_num_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (cam_frame_num_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (cam_frame_num_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (cam_frame_num_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (cam_frame_num_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (cam_frame_num_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (cam_frame_num_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (cam_frame_num_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (cam_frame_num_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (cam_frame_num_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (cam_frame_num_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),                    //                .error
		.rdata_fifo_src_ready    (cam_frame_num_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cam_frame_num_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (cam_frame_num_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cam_frame_num_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cam_frame_num_s1_agent_rf_source_data),               //        in.data
		.in_valid          (cam_frame_num_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (cam_frame_num_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (cam_frame_num_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (cam_frame_num_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (cam_frame_num_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (cam_frame_num_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (cam_frame_num_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (cam_frame_num_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (cam_frame_num_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cam_frame_num_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cam_frame_num_s1_agent_rdata_fifo_src_data),          //        in.data
		.in_valid          (cam_frame_num_s1_agent_rdata_fifo_src_valid),         //          .valid
		.in_ready          (cam_frame_num_s1_agent_rdata_fifo_src_ready),         //          .ready
		.out_data          (cam_frame_num_s1_agent_rdata_fifo_out_data),          //       out.data
		.out_valid         (cam_frame_num_s1_agent_rdata_fifo_out_valid),         //          .valid
		.out_ready         (cam_frame_num_s1_agent_rdata_fifo_out_ready),         //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	soc_system_mm_interconnect_0_router_009 router_013 (
		.sink_ready         (lcd_clk_s1_agent_rp_ready),                           //      sink.ready
		.sink_valid         (lcd_clk_s1_agent_rp_valid),                           //          .valid
		.sink_data          (lcd_clk_s1_agent_rp_data),                            //          .data
		.sink_startofpacket (lcd_clk_s1_agent_rp_startofpacket),                   //          .startofpacket
		.sink_endofpacket   (lcd_clk_s1_agent_rp_endofpacket),                     //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_009 router_014 (
		.sink_ready         (cam_wr_en_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (cam_wr_en_s1_agent_rp_valid),                         //          .valid
		.sink_data          (cam_wr_en_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (cam_wr_en_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (cam_wr_en_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_009 router_015 (
		.sink_ready         (cam_frame_num_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (cam_frame_num_s1_agent_rp_valid),                     //          .valid
		.sink_data          (cam_frame_num_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (cam_frame_num_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (cam_frame_num_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (sda_s1_burst_adapter_source0_valid),                  //   source0.valid
		.source0_data          (sda_s1_burst_adapter_source0_data),                   //          .data
		.source0_channel       (sda_s1_burst_adapter_source0_channel),                //          .channel
		.source0_startofpacket (sda_s1_burst_adapter_source0_startofpacket),          //          .startofpacket
		.source0_endofpacket   (sda_s1_burst_adapter_source0_endofpacket),            //          .endofpacket
		.source0_ready         (sda_s1_burst_adapter_source0_ready)                   //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (scl_s1_burst_adapter_source0_valid),                  //   source0.valid
		.source0_data          (scl_s1_burst_adapter_source0_data),                   //          .data
		.source0_channel       (scl_s1_burst_adapter_source0_channel),                //          .channel
		.source0_startofpacket (scl_s1_burst_adapter_source0_startofpacket),          //          .startofpacket
		.source0_endofpacket   (scl_s1_burst_adapter_source0_endofpacket),            //          .endofpacket
		.source0_ready         (scl_s1_burst_adapter_source0_ready)                   //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (lcd_data_s1_burst_adapter_source0_valid),             //   source0.valid
		.source0_data          (lcd_data_s1_burst_adapter_source0_data),              //          .data
		.source0_channel       (lcd_data_s1_burst_adapter_source0_channel),           //          .channel
		.source0_startofpacket (lcd_data_s1_burst_adapter_source0_startofpacket),     //          .startofpacket
		.source0_endofpacket   (lcd_data_s1_burst_adapter_source0_endofpacket),       //          .endofpacket
		.source0_ready         (lcd_data_s1_burst_adapter_source0_ready)              //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (lcd_clk_s1_burst_adapter_source0_valid),              //   source0.valid
		.source0_data          (lcd_clk_s1_burst_adapter_source0_data),               //          .data
		.source0_channel       (lcd_clk_s1_burst_adapter_source0_channel),            //          .channel
		.source0_startofpacket (lcd_clk_s1_burst_adapter_source0_startofpacket),      //          .startofpacket
		.source0_endofpacket   (lcd_clk_s1_burst_adapter_source0_endofpacket),        //          .endofpacket
		.source0_ready         (lcd_clk_s1_burst_adapter_source0_ready)               //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (cam_wr_en_s1_burst_adapter_source0_valid),            //   source0.valid
		.source0_data          (cam_wr_en_s1_burst_adapter_source0_data),             //          .data
		.source0_channel       (cam_wr_en_s1_burst_adapter_source0_channel),          //          .channel
		.source0_startofpacket (cam_wr_en_s1_burst_adapter_source0_startofpacket),    //          .startofpacket
		.source0_endofpacket   (cam_wr_en_s1_burst_adapter_source0_endofpacket),      //          .endofpacket
		.source0_ready         (cam_wr_en_s1_burst_adapter_source0_ready)             //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) cam_frame_num_s1_burst_adapter (
		.clk                   (clk_0_clk_clk),                                        //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  // cr0_reset.reset
		...
		.source0_valid         (cam_frame_num_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (cam_frame_num_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (cam_frame_num_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (cam_frame_num_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (cam_frame_num_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (cam_frame_num_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sda_s1_agent_rdata_fifo_out_data),                    //     in_0.data
		.in_0_valid     (sda_s1_agent_rdata_fifo_out_valid),                   //         .valid
		.in_0_ready     (sda_s1_agent_rdata_fifo_out_ready),                   //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (scl_s1_agent_rdata_fifo_out_data),                    //     in_0.data
		.in_0_valid     (scl_s1_agent_rdata_fifo_out_valid),                   //         .valid
		.in_0_ready     (scl_s1_agent_rdata_fifo_out_ready),                   //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lcd_data_s1_agent_rdata_fifo_out_data),               //     in_0.data
		.in_0_valid     (lcd_data_s1_agent_rdata_fifo_out_valid),              //         .valid
		.in_0_ready     (lcd_data_s1_agent_rdata_fifo_out_ready),              //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lcd_clk_s1_agent_rdata_fifo_out_data),                //     in_0.data
		.in_0_valid     (lcd_clk_s1_agent_rdata_fifo_out_valid),               //         .valid
		.in_0_ready     (lcd_clk_s1_agent_rdata_fifo_out_ready),               //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cam_wr_en_s1_agent_rdata_fifo_out_data),              //     in_0.data
		.in_0_valid     (cam_wr_en_s1_agent_rdata_fifo_out_valid),             //         .valid
		.in_0_ready     (cam_wr_en_s1_agent_rdata_fifo_out_ready),             //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cam_frame_num_s1_agent_rdata_fifo_out_data),          //     in_0.data
		.in_0_valid     (cam_frame_num_s1_agent_rdata_fifo_out_valid),         //         .valid
		.in_0_ready     (cam_frame_num_s1_agent_rdata_fifo_out_ready),         //         .ready
