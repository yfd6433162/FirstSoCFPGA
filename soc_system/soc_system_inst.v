	soc_system u0 (
		...
		.lcd_clk_external_connection_export       (<connected-to-lcd_clk_external_connection_export>),       //       lcd_clk_external_connection.export
		.lcd_data_external_connection_in_port     (<connected-to-lcd_data_external_connection_in_port>),     //      lcd_data_external_connection.in_port
		.lcd_data_external_connection_out_port    (<connected-to-lcd_data_external_connection_out_port>),    //                                  .out_port
		...
		.scl_external_connection_export           (<connected-to-scl_external_connection_export>),           //           scl_external_connection.export
		.sda_external_connection_export           (<connected-to-sda_external_connection_export>),           //           sda_external_connection.export
		.cam_wr_en_external_connection_export     (<connected-to-cam_wr_en_external_connection_export>),     //     cam_wr_en_external_connection.export
		.cam_frame_num_external_connection_export (<connected-to-cam_frame_num_external_connection_export>)  // cam_frame_num_external_connection.export
	);
